...
For engineers running, extending, testing, or deploying QI Stat Studio: a
FastAPI + SQLAlchemy backend under `api/`, a React + Vite frontend under
`web/src/`, and Alembic migrations against SQLite.
