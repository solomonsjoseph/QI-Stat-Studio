...
const QUESTIONS = [
  ...
  { key: 'q6', text: 'How many time points (or rows) do you have?', type: 'number', hint: "Run and control charts work best with 12 or more time points. If your data turns out to have fewer, the tool will use a run chart instead and say so in your Methods section." },
