...
const QUESTIONS = [
  ...
  { key: 'q2', text: 'What kind of outcome are you measuring?', type: 'radio', options: ['A rate of events over time (infections per 1,000 catheter-days)', 'A percentage or proportion (percent of patients screened)', 'A count (number of falls per month)', 'An average or median value (average LDL)', 'A yes/no outcome (did the patient get a flu shot)', 'Something else / not sure'], hint: 'Choose the option closest to your primary outcome.' },
  { key: 'q3', text: 'Are you comparing groups or time periods?', type: 'radio', options: ['Yes — before and after an intervention', "No — I'm just describing one time period", 'More than two periods (phases)', "I'm not sure"], hint: 'This decides whether we recommend comparison tests or descriptive summaries.' },
  { key: 'q4', text: 'Is your data tracked over time?', type: 'radio', options: ['Tracking over time (months, weeks, days)', 'Comparing groups at one point in time', 'Both', "I'm not sure"], hint: 'Run/control charts need a time column.' },
